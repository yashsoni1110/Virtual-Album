...
export declare const ImageKitContext: React.Context<ImageKitProviderProps>;
/**
 ...
 * ```
 */
export declare const ImageKitProvider: (props: ImageKitProviderProps) => React.JSX.Element;
